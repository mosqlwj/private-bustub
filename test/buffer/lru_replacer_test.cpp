...
TEST(LRUReplacerTest, SampleTest) {
  ...
  //  假设最近使用的放在最前面，那么此时是 1 6 5 4 3 2，根据LRU，victim应该是最后面的，为什么这里是1呢，应该是指，1已经在replacer里了，unpin对他是没有作用的
  //  实现1：victim，直接back加pop_back,为空就返回nullptr
  // TODO 那么问题来了，lru_replacer是根据什么维护LRU的性质？按照他们被放进lru_replacer的顺序？ 如果只看被放进replacer的顺序，那么此时应该是6,5,4,3,2,1
  ...
  // 问题在于，pin之后，他还在replacer中吗？还是说这个问题不重要？ pin了，就说了有人在使用它，肯定不能被evict，所以不在replacer中
